...
number = input ()
sumleft = int(number[0])+int(number[1])+int(number[2])
sumright = int(number[3])+int(number[4])+int(number[5])
happy = sumleft == sumright
print(f"Сумма первых трех цифр {sumleft}, сумма последних трех цифр {sumright}, {happy}")
